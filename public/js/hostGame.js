...
socket.on('gameQuestions', function(data){
    ...
    document.getElementById('playersAnswered').innerHTML = "Risposte: 0 / " + data.playersInGame;
    updateTimer();
});

socket.on('updatePlayersAnswered', function(data){
   document.getElementById('playersAnswered').innerHTML = "Risposte: " + data.playersAnswered + " / " + data.playersInGame; 
});
